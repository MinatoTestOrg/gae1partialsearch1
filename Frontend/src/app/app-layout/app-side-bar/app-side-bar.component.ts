...
export class AppSideBarComponent extends AppSideBarBaseComponent {
  constructor(bs: AppLayoutService, override translate: TranslateService, override utilBase: AppUtilBaseService,override router: Router,override location:PlatformLocation) {
    super(bs, translate, utilBase,router,location)
  }
  ngOnInit(): void {
    super.onInit();
  }
