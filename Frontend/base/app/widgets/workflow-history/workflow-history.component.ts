...
export class WorkflowHistoryComponent implements OnInit {
  ...
  constructor(public DynamicDialogRef: DynamicDialogRef, public config: DynamicDialogConfig, public appUtilBaseService: AppUtilBaseService,public appBaseService:AppBaseService,public translateService:TranslateService) { }
