...
public abstract class MaranTable123PerimeterBaseImpl<T extends MaranTable123Base> implements IPerimeterManager<T> {
	...
	protected void setReadFields(ApplicationUserBase userBase, AllowedFields allowedFields) {
		...
		if(BooleanUtils.isTrue(userBase.isDevAdmin())) {
			...
			String[] readFields = new String[] {"sid","createdBy","createdDate","modifiedBy","modifiedDate","maranfield1","maranfield2"};
