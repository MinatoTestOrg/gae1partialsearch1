...
public class MaranTable123BLBaseImpl<T extends MaranTable123Base> extends BaseBusinessLogic<T>
		implements IMaranTable123BLBase<T> {
		
	private ChangelogBLBaseImpl changelogBL;
	
	public MaranTable123BLBaseImpl(Class<T> modelClass) {
		super(modelClass);
	...
	public void onAfterSaveDB(T modelObj) {
	  changelogBL.createChangeLog("MaranTable123", modelObj.getSid(), Constants.SAVED, modelObj);
	}
	...
	public void onAfterUpdateDB(T modelObj) {
	  changelogBL.createChangeLog("MaranTable123", modelObj.getSid(), Constants.UPDATED, modelObj);
	}
	...
	public void onAfterDeleteDB(T modelObj) {
	  changelogBL.createChangeLog("MaranTable123", modelObj.getSid(), Constants.DELETED, modelObj);
	}	
